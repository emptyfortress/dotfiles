...
#+BEGIN_SRC emacs-lisp
   ...
   (defvar inbox-archive (gtd-path "inbox.org_archive"))
   (defvar gtd-archive (gtd-path "gtd.org_archive"))
   ;; (defvar keys (gtd-path "keys.org"))
  
   (setq org-agenda-files (list tickler inbox gtd ref someday))
   ;; (setq org-agenda-text-search-extra-files  (list inbox-archive gtd-archive))
