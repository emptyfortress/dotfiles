...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-mode emmet-mode embark-consult embark typescript-mode undo-fu evil-owl consult orderless marginalia vertico lorem-ipsum pug-mode elfeed org-download which-key zetteldeft deft company visual-regexp-steroids visual-regexp emojify olivetti exec-path-from-shell vue-mode yasnippet evil-vimish-fold vimish-fold ace-window evil-goggles evil-numbers diminish smart-mode-line-powerline-theme avy org-plus-contrib counsel-projectile projectile magit ivy-hydra counsel ivy smex ranger drag-stuff general evil gruvbox-theme use-package)))
(custom-set-faces
